export const notifications = {
    ...
    "user_with_id_has_started_phone_verification": "пользователь с идентификатором ${id} начал проверку телефона",
    "user_with_id_has_verified_phone_verification": "пользователь с идентификатором ${id} подтвердил телефон",
    "verify_for_user_with_id_has_been_expired": "срок проверки для пользователя с идентификатором ${id} истек",
};