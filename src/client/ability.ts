...
import {
    ON_CREATE_NEW_TASK,
    ON_CREATE_NEW_TASK_FAIL,
    ON_CREATE_NEW_TASK_SUCCESS,
    ON_EDIT_TASK, ON_EDIT_TASK_FAIL,
    ON_EDIT_TASK_SUCCESS,
    ON_NEW_TASK_RECEIVED,
    ON_TASK_CHANGE_STATUS,
    ON_TASK_DELETE,
    ON_TASK_DELETE_SUCCESS,
    ON_TASK_DELETED_BY_OWNER,
    ON_TASKS_BOARD_INITIALIZED,
    ON_TASKS_BOARD_INITIALIZED_FAIL,
    ON_TASKS_BOARD_INITIALIZED_SUCCESS
} from "store/tasks/actions";
import {
    ON_STATISTICS_INITIALIZED,
    ON_STATISTICS_INITIALIZED_FAIL,
    ON_STATISTICS_INITIALIZED_SUCCESS
...
const auth = (can: any) => {
    ...
    can(ABILITY_VISIT, URL_STATISTICS);
...
const USER = AbilityBuilder.define((can: any) => {
    ...
    can(ABILITY_DO, ON_STATISTICS_INITIALIZED);
    can(ABILITY_DO, ON_STATISTICS_INITIALIZED_SUCCESS);
    can(ABILITY_DO, ON_STATISTICS_INITIALIZED_FAIL);
    ...
    can(ABILITY_DO, ON_EDIT_TASK);
    can(ABILITY_DO, ON_EDIT_TASK_SUCCESS);
    can(ABILITY_DO, ON_EDIT_TASK_FAIL);
