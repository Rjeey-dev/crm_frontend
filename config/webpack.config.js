...
module.exports = function(webpackEnv, isServer) {
  ...
  const getResolve = () => {
    return {
      ...
      modules: [path.resolve(__dirname, '../src/common/components'), 'node_modules'].concat(
      ...
      alias: {
        ...
        'pages_templates': path.resolve(__dirname, '../src/common/components/templates/pages'),
        ...
        'themes': path.resolve(__dirname, '../src/common/components/themes'),
